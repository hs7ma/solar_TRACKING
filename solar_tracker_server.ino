// ============================================
//   نظام تتبع الشمس الذكي - مع Vercel Server
//   Solar Tracker + Vercel Dashboard
// ============================================
...
// رابط السيرفر على Vercel - غيّره بعد النشر
const char* SERVER_URL = "https://YOUR-PROJECT.vercel.app/api/data";
// ============================================
...
// ============================================
// 📡 إرسال البيانات إلى السيرفر (Vercel API)
// ============================================
void sendToServer() {
  ...
  while (attempts < 3 && !success) {
    ...
    if (code == 200) {
      Serial.println("✅ Server: تم الإرسال بنجاح");
      success = true;
    } else if (code > 0) {
      Serial.println("⚠️ Server: استجابة (code: " + String(code) + ") - محاولة " + String(attempts));
    } else {
      Serial.println("❌ Server: فشل الاتصال - محاولة " + String(attempts));
    }
